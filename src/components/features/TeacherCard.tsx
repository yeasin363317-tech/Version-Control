  ...
  return (
    <div className="card-base p-5 flex flex-col items-center text-center group">
      ...
      <Link
        ...
        className="flex items-center gap-2 text-sm font-semibold text-primary hover:bg-primary hover:text-primary-foreground px-4 py-2 rounded-full border border-primary transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
      >
        <Eye size={15} />
